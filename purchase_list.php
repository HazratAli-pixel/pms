										...
										<table id="zctb" class="display table table-striped table-bordered table-hover" >
											...
											<tbody>
												...
												<tr id="invoice-<?php echo htmlentities($result->InvoiceId);?>">
													...
													<td id="cusname-<?php echo htmlentities($result->InvoiceId);?>" ><?php echo htmlentities($result->cname);?>
														<p hidden><?php echo htmlentities($result->InvoiceId);?></p>
													</td>
													<td id="cusadd-<?php echo htmlentities($result->InvoiceId);?>" >SR</td>
													<td class="text-end" id="cusnetamount-<?php echo htmlentities($result->InvoiceId);?>" ><?php echo $result->Subtotal;?></td>
													<td class="text-end" id="cuspredue-<?php echo htmlentities($result->InvoiceId);?>" > <?php 
													$vat = ($result->Subtotal*$result->Vat)/100;
													echo $vat
													?></td>
													<td class="text-end" id="custotal-<?php echo htmlentities($result->InvoiceId);?>" ><?php echo $result->Discount;?></td>
													<td class="text-end" id="cuspaidamount-<?php echo htmlentities($result->InvoiceId);?>" ><?php echo $result->G_total;?></td>
													<td class="text-end" id="cusdueamount-<?php echo htmlentities($result->InvoiceId);?>" ><?php echo $result->Paid;?></td>
													<td class="text-center" id="cusdate-<?php echo htmlentities($result->InvoiceId);?>" ><?php echo $result->DueAmount;?></td>
													<td class="text-center" id="cusdate-<?php echo htmlentities($result->InvoiceId);?>" ><?php echo $result->Date;?></td>
