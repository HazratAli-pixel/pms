							...
							<div class="col-md-12">
								<div class="card" style="width: 100%;">
										<div class="card-header d-flex justify-content-between align-items-center h-100px">
											...
											<div >
												<a href="#"><button type="button" class="btn btn-info"><i class="fas fa-user mr-2" style="margin-right: 10px;"></i> Profile</button></a>
											</div>
										</div>
										<div class="card-body">
											<form method="post" class="row" enctype="multipart/form-data" onsubmit="return" >
												<div class="col-md-12">
													<div class="row mb-3">
														<label for="" class="col-sm-4 col-form-label text-start text-sm-end">Old Passwrod <i class="text-danger">* </i>: </label>
														<div class="col-sm-8">
												...
												<div class="col-md-12">
													<div class="row mb-3">
														<label for="" class="col-sm-4 col-form-label text-start text-sm-end">New Password<i class="text-danger">* </i>:</label>
														<div class="col-sm-8">
												...
												<div class="col-md-12">
													<div class="row mb-3 align-items-center">
														<label for="" class="col-sm-4 col-form-label text-start text-sm-end">Confirm New Password<i class="text-danger">* </i>:</label>
														<div class="col-sm-8">
