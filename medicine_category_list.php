						...
						<div class="panel panel-default">
							<div  class="panel-heading">
                                <div class="d-flex justify-content-between align-items-center h-100px">
									...
									<div >
                                        <a href="medicine_category_add.php"><button type="button" class="btn btn-info" style="margin-right: 15px;"><i class="fas fa-plus mr-2" style="margin-right: 10px;"></i> Add Category</button></a>                                                
									</div>
								</div>
                            </div>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php                                             
                                            $status = $result->MedicineCategoryStatus;
                                            if($status == 1){
                                                echo "Active";
                                            }
                                            else echo "Inactive";
											...
											<a href="medicine_category_edit.php?edit=<?php echo htmlentities($result->ID);?>" > <i class="fas fa-edit" aria-hidden="true"></i></a> 
