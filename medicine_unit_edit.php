...
include('includes/config.php');
	...
	if(strlen($_SESSION['alogin'])==0)
		...
		if($result)
			...
			header("refresh:3;medicine_unit_edit.php"); 
			}
	...
	<head>
		...
		<title>PMS| Medicine Unit edit</title>
								...
								<div class="col-md-12">
									<div class="card" style="width: 100%;">
										<div class="card-header d-flex justify-content-between align-items-center h-100px">
											...
											<div >
												<a href="medicine_unit_list.php"><button type="button" class="btn btn-info"><i class="fas fa-align-justify mr-2" style="margin-right: 10px;"></i>Medicine type List</button></a>
											...
											<form method="post" class="row" enctype="multipart/form-data" onsubmit="return" >
												...
												<div class="col-md-12">
													<div class="row mb-3">
														...
														<div class="col-sm-5">
														<input type="text" class="form-control" name="category" value="<?php echo htmlentities($result->MedicineUnit);?>"">
														</div>
													</div>
												</div>
